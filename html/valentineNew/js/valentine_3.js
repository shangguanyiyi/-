 	 ...
 	 $.ajax({
	        ...
	        success: function (data) {  
	            ...
	            if(json.code=="success"){
	            	...
	            	if(openId!=null&&openId!=""){
	            		var wx_url_temp=escape("http://www.fxzhoumo.com/operation/valentine/valentine.html?userid="+userId);
...
$(function(){
	...
	if(isWeixin){
		if(userCode=null||userCode==""){
			wx_url=escape("http://www.fxzhoumo.com/operation/valentine/valentine.html?userid="+userId);
