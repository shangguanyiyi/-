...
$(function(){
	var str1="strawberrybj1";
	var str2="strawberrybj2";
	var str3="strawberrybj3";
	...
	if(date==24){
		str1=str2;
		voucher1=762;
		str1.replace(/strawberrybj1/g,str2);
	}
	if(date==25){
		str1=str3;
		voucher1=763;
		str1.replace(/strawberrybj2/g,str3);
	}
	...
	$('.activity').attr('href','http://www.fxzhoumo.com/detail/course.html?courseid=6232');
		...
		if(browser.versions.ios || browser.versions.iPhone || browser.versions.iPad){
				...
				var uniqueId = 1;	
					$('.activity').bind("click",function(e){
						...
						var data = '{"activityID":6232,"activityTitle":"学习一下"}'									
				...
				$('.activity').bind("click",function(e){
					...
					// var t_id=$(this).attr('id');
					// var count = t_id.substr(4,1);
					window.FXZMAndroidJavaScript.jumpToDetailActivity(6232);  //安卓
					e.preventDefault(); 
				})
