...
var base_url="http://192.168.0.83/valentine/valentine/valentineNew.html";
var para_img;
//短信验证码倒计时
function setTime(){
...
$(function(){
	...
	if(userCode==null||userCode==""){//在普通浏览器中执行的一切
		...
		browserType=0;
		userCode="";
		sendRequest();//ajax同步请求 此请求完成之后执行下面的语句
