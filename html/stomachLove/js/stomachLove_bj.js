...
$(function(){
	...
	if(date==16){
		str1=str2;
		voucher1=712;
		str1.replace(/whjdbj1/g,str2);
	}
	if(date==17){
		str1=str3;
		voucher1=713;
		str1.replace(/whjdbj2/g,str3);
	}
	...
	if(hours>=11&&hours<24){
		...
		$('.button').css('border','1px solid #999');
	}
	$.ajax({
	...
	var courseIdLeft=[5791,5993,5780,6101];
    var courseIdRight = [6001,5835,5799,6021]; 
	var leftList=$('.left');
	var rightList=$('.right');
	for(var i=0;i<4;i++){
