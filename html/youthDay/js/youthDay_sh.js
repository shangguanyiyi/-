...
$(function(){
	var str1="youzhiqingniansh1";
	var str2="youzhiqingniansh2";
	var str3="youzhiqingniansh1"
	var voucher1;
	var curr=new Date();
	...
	if(date==5){
		str1=str2;
		voucher1=817;
		str1.replace(/youzhiqingniansh1/g,str2);
	}
	if(date==6){
		str1=str3;
		voucher1=818;
		str1.replace(/youzhiqingniansh2/g,str3);
	}
	...
	var courseIdLeft=[5978,5452,5967];
    var courseIdRight = [5648,5315,6246]; 
	var leftList=$('.left');
	var rightList=$('.right');
	for(var i=0;i<3;i++){
