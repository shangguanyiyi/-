...
$(function(){
	var str1="youzhiqingnianbj1";
	var str2="youzhiqingnianbj2";
	var str3="youzhiqingnianbj3"
	var voucher1;
	var curr=new Date();
	...
	if(date==5){
		str1=str2;
		voucher1=814;
		str1.replace(/youzhiqingnianbj1/g,str2);
	}
	if(date==6){
		str1=str3;
		voucher1=815;
		str1.replace(/youzhiqingnianbj2/g,str3);
	}
	...
	var courseIdLeft=[6119,6344,6230];
    var courseIdRight = [6295,6193,6316]; 
	var leftList=$('.left');
	var rightList=$('.right');
	for(var i=0;i<3;i++){
