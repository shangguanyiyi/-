...
$(function(){
	var str1="youthmusic1";
	var str2="youthmusic2";
	var str3="youthmusic3"
	var voucher1;
	var curr=new Date();
	...
	if(date==26){
		str1=str2;
		voucher1=768;
		str1.replace(/youthmusic1/g,str2);
	}
	if(date==27){
		str1=str3;
		voucher1=769;
		str1.replace(/youthmusic2/g,str3);
	}
	...
	var courseIdLeft=[6095,6216,6066];
    var courseIdRight = [6100,6067,6043]; 
	var leftList=$('.left');
	var rightList=$('.right');
	for(var i=0;i<3;i++){
