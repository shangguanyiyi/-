...
$(function(){
	var str1="youthmusic4";
	var str2="youthmusic5";
	var str3="youthmusic6"
	var voucher1;
	var curr=new Date();
	...
	if(date==26){
		str1=str2;
		voucher1=771;
		str1.replace(/youthmusic4/g,str2);
	}
	if(date==27){
		str1=str3;
		voucher1=772;
		str1.replace(/youthmusic5/g,str3);
	}
	...
	var courseIdLeft=[6232,6258,6242];
    var courseIdRight = [6240,6251,6247]; 
	var leftList=$('.left');
	var rightList=$('.right');
	for(var i=0;i<3;i++){
