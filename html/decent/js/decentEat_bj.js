...
$(function(){
	...
	if(isWeixin){
		...
		$('.button').bind('click',function(){
			...
			$.ajax({
				...
				type:"post",
				data:'servicestr={"user_mobile":"'+phone+'","codenumstr":"brgccmbja"}',
				...
				if(json.code=="success"){
					...
					$('.button').bind('click',function(){
						$.ajax({
							...
							type:'post',
							data:'servicestr={"codenum":"brgccmbja"}',
							success:function(data){
	...
	var courseIdLeft=[5896,5908,5598,5472];
    var courseIdRight = [5130,5902,5949,5196]; 
	var leftList=$('.left');
	var rightList=$('.right');
	for(var i=0;i<4;i++){
