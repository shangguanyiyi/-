...
$(function(){
	...
	if(isWeixin){
		...
		$('.button').bind('click',function(){
			...
			$.ajax({
				...
				type:"post",
				data:'servicestr={"user_mobile":"'+phone+'","codenumstr":"brgccmsha"}',
				...
				if(json.code=="success"){
					...
					$('.button').bind('click',function(){
						$.ajax({
							...
							type:'post',
							data:'servicestr={"codenum":"brgccmsha"}',
							success:function(data){
	...
	var courseIdLeft=[5363,5978,5260,5077];
    var courseIdRight = [5359,5565,5810,5452]; 
	var leftList=$('.left');
	var rightList=$('.right');
	for(var i=0;i<4;i++){
