...
function getModel(modelIndex,courseIndex){
	...
	var str1='<a href="home/index.html?courseid='+tcrarr[courseIndex].courseid+'"><div class="produce"><p class="pro_theme" id="pro_theme'+modelIndex+courseIndex+'"></p>'+str2+'</div></a>'+str4;
	var moren='<div class="info"><a href="home/index.html?courseid='+tcrarr[courseIndex].courseid+'"><div class="big"><img id="bigpic'+modelIndex+courseIndex+'" src="img/loading.png" class="banner" width="100%"/><div class="mask" id="mask'+modelIndex+courseIndex+'"><img src="img/mask2.png"></div></div></a>'+str1+'</div>' ;
	return moren;
}
//清理模块里的内容
				...
				if(severalTime==0){//如果是第一次就添加  第二次不添加	
						for(i=1;i<=6;i++){
							!function(){
								...
								mySwiper2.appendSlide('<div class="swiper-slide">'
									+'<a id='+e[i].tag_id+' data='+i+'>'+e[i].tag_name
									+'</a>'+'</div>');	

								mySwiper3.appendSlide('<div class="swiper-slide" id="slide'+i+'"> </div>')		
