			...
			bindEvent:function(data){
				...
				We.addEvent(this.signBtn,"click",function(){
					...
					if(!isWeiXin){
						...
						url="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx47987fa108b8329b&redirect_uri=http://www.fxzhoumo.com/list/sign.jsp?courseid="+courseid+"&course_price_id="+courseid_price_id+"&response_type=code&scope=snsapi_base&state=1#wechat_redirect";
					}
