            ...
            success:function(data){       
                ...
                if(json.code=="success"){
                    ...
                    if(course_description_arr_length==""){
                        ...
                        var before=/\[img:/g;
                        var after=/:img\]/g;
                        course_description=d.join('').replace(before,"<img src='"+config_url).replace(after,"'/>");
                    }else{
                        ...
                        for(var i=0;i<course_description_arr_length;i++){
                            ...
                            var before=/\[img:/g;
                            var after=/:img\]/g;
                            var cc=course_description_content.replace(before,"<img class='image_text_img' src='"+config_url).replace(after,"'/>");
            ...
            success:function(data){
                ...
                if(value.code=="success"){
                    ...
                    for (var i = 0; i < arr; i++) {
                        ...
                        $("#local_href_"+i).attr("href","http://www.fxzhoumo.com/detail/particulars-test.html?courseid="+tcrarr[i].courseid);               
                   }         
                }else{                                
