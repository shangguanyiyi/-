...
$(function(){
	...
	if(isWeixin){
		...
		$('.button').bind('click',function(){
			...
			$.ajax({
				...
				type:"post",
				data:'servicestr={"user_mobile":"'+phone+'","codenumstr":"yjrlbja"}',
				...
				if(json.code=="success"){
					...
					$('.button').bind('click',function(){
						$.ajax({
							...
							type:'post',
							data:'servicestr={"codenum":"yjrlbja"}',
							success:function(data){
	...
	$('.close').bind('click',function(){
	 ...
	 var courseIdLeft=[5923,5009,5231,5793];
     var courseIdRight = [5205,5370,5855,4902]; 
	var leftList=$('.left');
	var rightList=$('.right');
	for(var i=0;i<4;i++){
